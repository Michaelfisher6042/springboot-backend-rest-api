...
//    }
    ...
    // displaying list of all general_details
        @GetMapping("/api/general_details")
        ...
        @PutMapping("/api/general_details/{id}")
        ...
        @DeleteMapping("/api/general_details/{id}")
